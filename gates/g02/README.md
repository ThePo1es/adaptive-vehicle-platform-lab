...
학습자 코드, ABI 오브젝트, C++20 표준 라이브러리 확인 프로그램의 컴파일은 명령마다 120초 안에 끝나야 합니다. Zig 버전·대상 조회는 30초, 만들어진 시험 프로그램의 실행은 15초 안에 끝나야 합니다. 제한 시간을 늘려야만 통과하는 제출물은 원인을 먼저 줄여서 재현합니다.
...
| [2-3 기다리는 스레드를 남기지 않고 닫는 작업 큐 만들기](sprint-2.3.md) | 생산자 2개와 소비자 1개가 함께 쓰는 용량 8의 큐 | 30–40시간 | Runnable |
