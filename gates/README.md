...
| G4–G7 | [Gate Playbook](../docs/gate-playbook.md) | Outline; 27 Sprint 작성 필요 |
...
현재 91개 중 49개가 `Specified`, 42개가 `Outline`입니다. 이 수치는 문서 작성 진도이며 학습 효과를 뜻하지 않습니다.
...
파일을 `Runnable`로 올릴 때는 starter와 fixture commit SHA를 이 문서에 연결합니다. 빈 SHA나 아직 실행하지 않은 inline fixture는 `Specified` 상태로 둡니다.
