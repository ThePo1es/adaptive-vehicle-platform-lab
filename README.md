...
현재 저장소에는 커리큘럼과 평가 체계가 들어 있습니다. 1장과 2장, 3장의 네 실습은 기준 구현·자동 검사를 바로 실행할 수 있습니다. 3장의 GCC·Clang 비교는 공식 GNU 아카이브가 검증될 때까지 `Provisional`이며, 학습자가 직접 만드는 포트폴리오는 아직 시작 전입니다.
