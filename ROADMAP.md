...
| [G3 Arm 프로그램의 함수 호출부터 기계어까지 추적하기](gates/g03/README.md) | 120–150h | 5 | 컴파일 분석 묶음 |
...
## [Arm 프로그램의 함수 호출부터 기계어까지 추적하기 (G3)](gates/g03/README.md)
...
- 같은 Cortex-M4·Thumb·AAPCS32·soft-float 재배치 ELF의 크기 비교 보고서. runtime·cycle·cross-LTO는 보드 근거가 생길 때까지 결론을 보류
