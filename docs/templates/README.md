...
| Template | Use when |
| --- | --- |
| [Learning note](learning-note.md) | 개념·문서·코드를 공부해 자기 말로 정리할 때 |
| [Experiment report](experiment-report.md) | 가설을 실행 결과로 검증할 때 |
| [Project README](project-readme.md) | 새 미니 프로젝트를 시작할 때 |
