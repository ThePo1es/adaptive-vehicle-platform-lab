...
76개 실습 안내서는 `Specified`, G1.1–G1.5·G2.1–G2.4·G3.1–G3.3·G3.5·G10.1은 `Runnable` 상태입니다. G3.4는 공식 Arm GNU Toolchain 14.3.Rel1 아카이브를 이 환경에서 마련하지 못해 `Provisional`입니다. G1은 C17 기준 구현·시작 코드·독립 검사, G2는 C++20 입력 A·B와 결함 주입, G3는 ARM32 호출·AArch64 주소 복원·LLVM IR·이슈 결정 검사와 결함 주입을 잠갔습니다. 실제 Cortex-M/AArch64 보드 실행, cycle, runtime, cross-LTO 비교는 아직 기록하지 않았습니다.
...
| 전체 91개 실습 명세 | 해결 | 76개 Specified, G1 5개·G2 4개·G3 4개·G10.1 Runnable, G3.4 Provisional |
...
- G3 ARM32/AArch64 재배치 ELF, LLVM IR·Thumb 산출물, defined/UB 분리, 이슈 양·음성 대조군 재실행; GNU 비교는 Provisional
